...
define(['bignum', 'cryptojs.sha1', 'cryptojs.sha512'], function (Bn, CryptoJS) {
    ...
    Srp.prototype = {
        ...
        getM1String: function () {
            return this.getM1().toString(16, this.hash_size);
        },
        ...
        getM2: function (M1) {
            var hash = CryptoJS.algo.SHA1.create()
                        .update(CryptoJS.enc.Hex.parse(this.getA().toString(16, this.strenght)))
                        .update(CryptoJS.enc.Hex.parse(M1 || this.getM1().toString(16, hash_size)))
                        .update(CryptoJS.enc.Hex.parse(this.getS().toString(16, this.strenght)))
                        .finalize();
         ...
         */
        getM2String: function () {
            return this.getM2().toString(16, this.hash_size);
        },
        ...
        getK: function () {
            if (this.K === undefined) {
                this.K = CryptoJS.SHA512(CryptoJS.enc.Hex.parse(this.getS().toString(16, this.strenght)));
